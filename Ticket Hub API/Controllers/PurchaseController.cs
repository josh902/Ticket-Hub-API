...
namespace Ticket_Hub_API.Controllers
{
    ...
    public class PurchaseController : ControllerBase
    {
        ...
        public async Task<IActionResult> SubmitPurchase([FromBody] TicketPurchase purchase)
        {
            ...
            string connectionString = "DefaultEndpointsProtocol=https;AccountName=nscc0468743storageacct;AccountKey=07DplxGAypPorxXJHXwflTAaXcdaB5Z2XJpeQ9uQBr/p9BMMlKbxdNcDpY25yQ1vsMnvch6MI2AS+AStIkYJiQ==;EndpointSuffix=core.windows.net"; // Replace this
